...
Para los pasos de exportar historial, descargar y enviar por correo, sigue las instrucciones comunes: [Cómo entregar las prácticas](/es/utils/entrega/) (usa `N = 2`).
