...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>775</code></td>
            <td class="yes">✅ Sí</td>
            <td>El equipo puede leer y escribir; los archivos nuevos heredan el grupo</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><code>754</code></td>
            <td class="no">❌ No</td>
            <td>El equipo solo puede leer los logs, no escribirlos</td>
        </tr>
        <tr>
            ...
            <td class="yes">✅ Sí</td>
            <td>Directorio compartido: hereda grupo y permite colaboración</td>
        </tr>
        <tr>
            ...
            <td><code>755</code></td>
            <td class="no">❌ No</td>
            <td>Publicable: cualquiera lee/ejecuta, nadie escribe salvo root</td>
        </tr>
    </tbody>
</table>
...
Para los pasos de exportar historial utiliza `history`, sigue las instrucciones comunes: [Cómo entregar las prácticas](/es/utils/entrega/).
