...
### [4.1 El Proceso de Arranque (Boot)](/es/module-4/1-boot-process/)
...
### [4.2 Configuración de GRUB y el Kernel](/es/module-4/2-grub-kernel/)
...
### [4.3 Systemd: El Rey de los Servicios](/es/module-4/3-systemd-services/)
...
### [4.4 Auditoría Forense y Logs](/es/module-4/4-logging-journalctl/)
