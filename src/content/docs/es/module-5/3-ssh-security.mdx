...
<Aside type="caution">
  Antes de añadir `PasswordAuthentication no`, ¡asegúrate de que tu inicio de
  sesión con clave funciona! De lo contrario, ejecutas "El Bloqueo Digital" y
  pierdes el acceso a tu servidor.
</Aside>
