...
{/* ![Ejemplo anotado de permisos -rwxr-xr-- explicado](../../../../../assets/module-2/permissions/ejemplo-anotado-rwxr-xr--.webp) */}

<Aside type="caution" title="Dato curioso: 777 no arregla, expone">
  `777` suele “funcionar” porque elimina la seguridad. En sistemas reales, es
  una de las causas más comunes de incidentes y borrados accidentales: si todos
  pueden escribir, cualquiera (o cualquier proceso) puede romperlo.
</Aside>
...
<Aside type="tip" title="Truco LFCS">
  Si un ejercicio pide “que los ficheros nuevos NO sean legibles por otros”, en
  vez de chmod repetido, ajusta `umask` antes de crear.
</Aside>

---

## 5. Bits especiales: SUID, SGID y Sticky
...
### Sticky bit (carpetas compartidas seguras)
...
<Aside type="note">
  SUID/SGID en ejecutables existen, pero en LFCS lo más frecuente en prácticas es
  SGID en directorios y sticky en carpetas compartidas.
</Aside>
