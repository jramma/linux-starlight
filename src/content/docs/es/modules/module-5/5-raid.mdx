...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>2</td>
            <td>❌ Ninguna</td>
            <td>⚡ Doble lectura/escritura</td>
            <td>100%</td>
            <td>Scratch/tmp (si el disco muere, pierdes todo)</td>
        </tr>
        <tr>
            <td><strong>RAID 1</strong></td>
            <td>2</td>
            <td>✅ 1 disco</td>
            <td>✅ Lectura paralela</td>
            <td>50%</td>
            <td>Boot, sistema operativo, BD pequeñas</td>
        </tr>
        <tr>
            ...
            <td>✅ Buena lectura</td>
            <td>~67-93%</td>
            <td>Almacenamiento de datos, NAS</td>
        </tr>
        <tr>
            ...
            <td>Buena lectura</td>
            <td>~50-88%</td>
            <td>Archivos críticos (aguanta 2 fallos)</td>
        </tr>
        <tr>
            ...
            <td>⚡ Excelente</td>
            <td>50%</td>
            <td>Bases de datos de alto rendimiento</td>
        </tr>
    </tbody>
</table>
