...
### [7.5 iptables y nftables](/es/modules/module-7/5-iptables/)

- UFW (módulo 4.4) es una capa de abstracción sobre iptables, que a su vez es la interfaz de espacio de usuario para netfilter, el subsistema de filtrado de paquetes del kernel.
- El examen LFCS puede pedirte trabajar directamente con iptables cuando UFW no está disponible o cuando necesitas reglas más precisas.

### [7.6 Seguridad SSH Avanzada](/es/modules/module-7/6-ssh-security/)
