...
<table>
    <thead>
        <tr>
            <th>Tabla</th>
            <th>Propósito</th>
            <th>Cadenas principales</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td><code>filter</code></td>
            <td>Filtrado de paquetes (la más usada)</td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Servidor estándar, reglas simples, gestión rápida</td>
        </tr>
        <tr>
            <td><strong>iptables</strong></td>
            <td>Compatibilidad con scripts antiguos, entornos legacy, examen LFCS</td>
        </tr>
        <tr>
            <td><strong>nftables</strong></td>
            <td>Sistemas nuevos, alta carga de paquetes, reglas complejas</td>
        </tr>
    </tbody>
</table>
