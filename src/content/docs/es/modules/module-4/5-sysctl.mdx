...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Comportamiento del kernel (hostname, coredumps, sysrq)</td>
        </tr>
        <tr>
            <td><code>/proc/sys/net/</code></td>
            <td>Pila de red (IP forwarding, syn cookies, buffers)</td>
        </tr>
        <tr>
            <td><code>/proc/sys/vm/</code></td>
            <td>Memoria virtual (swappiness, overcommit)</td>
        </tr>
        <tr>
            <td><code>/proc/sys/fs/</code></td>
            <td>Límites del sistema de ficheros (file-max, inotify)</td>
        </tr>
    </tbody>
</table>
