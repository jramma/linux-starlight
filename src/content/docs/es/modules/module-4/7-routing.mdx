...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Ruta por defecto (gateway de último recurso)</td>
        </tr>
        <tr>
            <td><code>via 192.168.1.1</code></td>
            <td>Siguiente salto (el router)</td>
        </tr>
        <tr>
            <td><code>dev eth0</code></td>
            <td>Interfaz de salida</td>
        </tr>
        <tr>
            <td><code>proto dhcp</code></td>
            <td>Cómo se aprendió la ruta (dhcp/static/kernel)</td>
        </tr>
        <tr>
            <td><code>metric 100</code></td>
            <td>Coste (menor = preferida si hay varias rutas al mismo destino)</td>
        </tr>
    </tbody>
</table>
