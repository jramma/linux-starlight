...
- ¿Qué suele fallar aquí?: Suele morir en el minuto 1 escupiendo `error: gcc compiler not found`. Tendrías que instalar el paquete de herramientas de compilación de tu distro:
  ...
  O puede gritar `error: missing libssl`. Lo cual te obligará a buscar la librería OpenSSL y volver a lanzar el configure.
